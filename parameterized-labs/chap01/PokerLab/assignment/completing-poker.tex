...
You will receive a half-point for demonstrating that you \textunderscore{understand what the outputs of C's logical boolean operations are} and what they mean,
and you will receive a half-point for demonstrating that you fully understand \textunderscore{how the inputs to C's logical boolean operations are interpreted}.
