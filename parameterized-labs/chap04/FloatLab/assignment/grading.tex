...
\begin{description}
    ...
    \rubricitem{2}{\function{ieee754_to_string()} and \function{decode()} correctly extract the significand}
    \rubricitem{2}{\function{ieee754_to_string()} and \function{decode()} correctly extract the exponent}
...
\begin{description}
    ...
    \penaltyitem{27}{\function{decode()} and/or \function{encode()} use \lstinline{float} or \lstinline{double} variables or constants, use \lstinline{union} variables, use C's floating point operations, and/or a function you did not write}
    \item[] If \function{decode()} and \function{encode()} are not penalized:
