 ...
 *
 * @brief Functions to configure interrupts and register ISRs
 *
 * @copydetails These functions simplify managing interrupts by wrapping
 *      platform-specific code in easy-to-use functions.
 *
 ******************************************************************************/
