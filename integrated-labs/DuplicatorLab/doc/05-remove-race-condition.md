...
- [ ] In the Canvas quiz, identify where in the original code the mutex should be locked and unlocked, using the line numbers from [the section about understanding the code](03-understanding-code.md).
- [ ] In the Canvas quiz, make a copy of the interleaving you provided for your answer to the first question and paste it into the space for your answer to the fourth question.
...
- [ ] Add calls to `pthread_mutex_lock()` and `pthread_mutex_unlock()`, as appropriate, in `read_original()` and `write_copy()` to lock and unlock the mutex.
  - These locations should correspond to your answers to the second and third questions in the Canvas quiz.
    The syntax is in [Chapter&nbsp;8](https://unl.grlcontent.com/compeng2e/page/chapter8) and [Appendix&nbsp;C](https://unl.grlcontent.com/compeng2e/page/appendixc#c18) of the textbook.
