...
/*
 * LinkedListLab assignment and starter code (c) 2021-22 Christopher A. Bohn
...
void insert_before(struct node *existing_node, struct node *new_node) {
    /* YOU DO NOT NEED TO WRITE THIS FUNCTION (BUT YOU MAY) */
}
 ...
 * in the file.
 * NOTE: THIS FUNCTION SHOULD RETURN A POINTER TO THE NODE WITH THE
