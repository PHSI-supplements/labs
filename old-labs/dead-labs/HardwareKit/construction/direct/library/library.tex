...
\ifdefstring{\serialprotocol}{SPI}{
    \begin{description}
        ...
        \begin{itemize}
            \item{The hardware kit is configured slightly differently, depending on which serial communication protocol is used with the display module, and this semester we will use the SPI protocol.}
        \end{itemize}
    \end{description}
}{}
%! suppress = NonMatchingIf
\ifdefstring{\serialprotocol}{I2C}{
    \begin{description}
        ...
        \begin{itemize}
            \item{The hardware kit is configured slightly differently depending on which serial communication protocol is used with the display module, and this semester we will use the I$^2$C protocol.}
        \end{itemize}
    \end{description}
}{}
