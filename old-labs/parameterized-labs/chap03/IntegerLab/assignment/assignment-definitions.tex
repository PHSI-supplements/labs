...
\newcommand{\labname}{Integer Representation and Arithmetic Lab}
\newcommand{\shortlabname}{IntegerLab}
\newcommand{\duedate}{Week of February 17, before the start of your lab section}
...
\newcommand{\startercode}{integerlab.zip or integerlab.tar}
\newcommand{\requiredfiles}{\textit{basetwo.c} and \textit{alu.c}}
...
\newcommand{\softwareengineeringpenalties}{\penaltyitem{1}{for each \lstinline{goto} statement,
            ...
            a loop.}}
\newcommand{\scenariointroduction}{All work at the Pleistocene Petting Zoo has stopped while Archie tries to find a $\cancelto{\mathrm{reasonable}}{\mathrm{gullible}}$ insurance company.
...
\newcommand{\scenariowrapup}{Herb smiles as he hands you the the test results from the latest integrated circuit fab batch.
