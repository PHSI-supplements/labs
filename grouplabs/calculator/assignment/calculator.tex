...
bouncing will occur. For this reason we recommend:
    ...
    \item The software debouncing will look similar to what you used in
        ...
        \item Including \function{delay()} calls in an interrupt handler is particularly ill-advised since interrupts are disabled by default in the interrupt handler. The \function{delay()} function will never exit, blocking forever, if interrupts are disabled.
        \end{itemize}
    \end{itemize}
...
\penaltyitem{7}{The pushbutton interrupt handler's implementation violates one or more constraints identified in Section~\ref{sec:Constraints}.}
\penaltyitem{7}{The keypad interrupt handler's implementation violates one or more constraints identified in Section~\ref{sec:Constraints}.}
\penaltyitem{7}{The timer ISR's implementation violates one or more constraints identified in Section~\ref{sec:Constraints}.}
\penaltyitem{4}{The timeout logic violates one or more constraints identified in Section~\ref{sec:Constraints}.}
\penaltyitem{23}{The remainder of the calculator's implementation violates one or more constraints identified in Section~\ref{sec:Constraints}.}
...
\begin{enumerate}
\precheckoffitem{Establish that the code you are demonstrating is the code you submitted to to \filesubmission.}
    \begin{itemize}
...
\checkoffitem{Show the TA that your code is well-organized and readable.} \\
...
\checkoffitem{Show in your code that you registered interrupt handlers for the pushbuttons and for the matrix keypad.}
\checkoffitem{Show in your code your interrupt handlers for the pushbuttons and for the matrix keypad.} \\
...
\checkoffitem{Show and explain how you determined the comparison value and prescaler for your timer interrupts. Explain why the timer period you selected is appropriate.
    \[comparison\_value = 16,000,000 \times interrupt\_period \div prescaler\]
    }
\checkoffitem{Show in your code that you had configured the timer to use those comparison and prescaler values and that you had configured the correct timer mode.} \\
...
\checkoffitem{Upload \textit{CalculatorLab.ino} to your \nano.}
\vspace{.5cm} \\
...
\item[] \textbf{Interrupt Handling without Calculator Functionality}
\checkoffitem{Press the left button to show that the system responds to the left button, such as illuminating an LED.} \label{checkoff:interruptsOnly}
\checkoffitem{Press the right button to show that the system responds to the right button differently, such as illuminating a different LED.} \\
    \textit{+2 pushbutton interrupt handler determines which button was pressed.}
\checkoffitem{Press a few keys on the keypad to show that something unique about each key (such as its face value) is displayed.} \\
    \textit{+2 keypad interrupt handler determines which key was pressed.}
\vspace{.5cm} \\
\textit{If you did not implement the calculator, jump to step~\ref{checkoff:timeout}.} \\ \\

\item[] \textbf{Calculator Functionality}
\checkoffitem{The display shows:} \label{checkoff:calculator} \\
...
\checkoffitem{Enter 123,456. The display shows:} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
    ...
    \textit{+2 keypad interrupt handler determines which key was pressed.}
\checkoffitem{\textbf{If you implemented display timeout:} After a few seconds, he display goes blank.}
\checkoffitem{\textbf{If you implemented display timeout:} Press 7. The display resumes, showing what it previously showed:} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
        \rowcolor{LightGreen}\display{ } & \display{123456}
    \end{tabular} \\
...
\checkoffitem{Press the right pushbutton (clear).} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
        \rowcolor{LightGreen}\display{ } & \display{ }
    \end{tabular} \\
...
\checkoffitem{Enter -123,456,789, using the left pushbutton for the negative sign.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
...
\checkoffitem{Press 0. The display is unchanged; it still shows:} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
        \rowcolor{LightGreen}\display{ } & \display{-123545789}
    \end{tabular} \\
...
\checkoffitem{Press \texttt{\#}.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        ...
        \rowcolor{LightGreen}\display{ } & \display{ }
    \end{tabular}
\checkoffitem{Enter 231.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{-123545789} \\
        \rowcolor{LightGreen}\display{ } & \display{231}
    \end{tabular}
\checkoffitem{Press \texttt{B} (subtraction) and enter 321.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{231} \\
...
\checkoffitem{Press the right pushbutton (clear).} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        ...
        \rowcolor{LightGreen}\display{ } & \display{ }
    \end{tabular}
\checkoffitem{Press \texttt{C} (multiplication) and enter 12.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
        \rowcolor{LightGreen}\display{x} & \display{12}
    \end{tabular}
\checkoffitem{Press \texttt{\#}.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
        \rowcolor{LightGreen}\display{ } & \display{ }
    \end{tabular}
\checkoffitem{Enter 42.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{0} \\
        \rowcolor{LightGreen}\display{ } & \display{42}
    \end{tabular}
\checkoffitem{Press \texttt{D} (division) and enter 6.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{42} \\
        \rowcolor{LightGreen}\display{÷} & \display{6}
    \end{tabular}
\checkoffitem{Press \texttt{\#}.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{7} \\
        \rowcolor{LightGreen}\display{ } & \display{ }
    \end{tabular} \\
    \textit{+2 division works}
\checkoffitem{Press \texttt{C} (multiplication) and enter 73.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{7} \\
...
\checkoffitem{Press \texttt{C} (multiplication) and enter 200.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{511} \\
...
\checkoffitem{Press \texttt{C} (multiplication) and enter 2,000,000.} \\
    \begin{tabular}{>{\raggedright}p{.5cm}>{\raggedleft\arraybackslash}p{4cm}}
        \rowcolor{LightGreen}\display{ } & \display{511} \\
...
\item[] \textbf{Display Timeout}
\checkoffitem{Prepare a stopwatch or another timepiece with a ``seconds'' display (or a ``seconds'' hand)} \label{checkoff:timeout}
\checkoffitem{Place the left switch in the right position.}
\checkoffitem{If necessary, re-activate the backlight by pressing a button or key.}
\checkoffitem{Press a button or key on the system at the exact same time as starting the stopwatch (or at the exact moment that the ``seconds'' display/hand hits \textit{00}).}
\checkoffitem{Exactly 7.5~seconds later, the backlight deluminates.} \\
    \textit{+2 System can determine when 7.5 seconds have passed} \\
    \textit{+1 Backlight deluminates after 7.5 seconds of inactivity}
\checkoffitem{Place the left switch in the left position.}
\checkoffitem{Re-activate the backlight by pressing a button or key.}
\checkoffitem{Press a button or key on the system at the exact same time as starting the stopwatch (or at the exact moment that the ``seconds'' display/hand hits \textit{00}).}
\checkoffitem{Exactly 20~seconds later, the backlight deluminates.} \\
    \textit{+2 System can determine when 20 seconds have passed} \\
    \textit{+1 Backlight deluminates after 20 seconds of inactivity}
\end{enumerate}


This concludes the demonstration of your system's functionality.
The TAs will later examine your code for violations of the assignment's constraints and deduct any unearned points accordingly.
