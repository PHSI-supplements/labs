...
\begin{description}
    ...
    \checkoffitem{Use a 20cm wire to connect the piezodisc's red lead to the \developmentboard's pin D13 (contact point a1 is a good choice).}
...
\begin{description}
    \checkoffitem{Insert the ultrasonic echo sensor unused rows on the breadboard, pointing away from you.
