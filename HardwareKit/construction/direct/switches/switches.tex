...
\prepunch{a\controlrow{1}--a\controlrow{3} and a\controlrow{6}--a\controlrow{8}}

Insert one slider switch into contact points a\controlrow{1}--a\controlrow{3}. % (for 3-pin switches) or contact points a\controlrow{1}--a\controlrow{4} (for 2-pin switches).
Place the other slider switch  into contact points a\controlrow{6}--a\controlrow{8}. % (for 3-pin switches) or contact points a\controlrow{6}--a\controlrow{9} (for 2-pin switches).
...
Peel off one wire from the \rainbow\ and use it to connect contact point e\controlrow{1} (electrically connected to the left switch's left pin) to contact point \mculeftswitchpoint\ (electrically connected to the \developmentboard's \mculeftswitch\ pin).
Peel off another wire from the \rainbow\ and use it to connect contact point e\controlrow{6} (electrically connected to the right switch's left pin) to contact point \mcurightswitchpoint\ (electrically connected to the \developmentboard's \mcurightswitch\ pin).
...
to the upper \ground.
Specifically, place the end of one wire into contact point e\controlrow{2}; %(for 3-pin switches) or e\controlrow{4} (for 2-pin switches);
place the other end of that wire into the upper \ground.
Now place the end of the other wire into contact point e\controlrow{7}; %(for 3-pin switches) or e\controlrow{9} (for 2-pin switches);
place the other end of that wire into the upper \ground.
