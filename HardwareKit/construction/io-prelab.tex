...
\input{macros.tex}
\input{contact-points.tex}
\input{breadboard-guides/breadboard-template.tex}
...
\section{Inventorying the Hardware} \label{sec:inventory}   \input{inventory/inventorying-the-hardware.tex}
...
\section{Matrix Keypad} \label{sec:keypad}                  \input{keypad/matrix-keypad.tex}
