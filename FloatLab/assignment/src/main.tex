...
\begin{document}
    ...
    Examine the stub for \function{print_ieee754()}.
...
%    Run \texttt{./integer lab unsigned} (or run \texttt{./integer grader})
%    \begin{description}
...
%        \rubricitem{2}{Negative differences do overflow; for example, 2-3  = 65535 and
%        reports Overflow}
...
%
%
%    Run \texttt{./integer lab signed} (or run \texttt{./integer grader})
%    \begin{description}
...
%        function you did not write,
%            \textit{and/or} \function{multiply()} uses a super-polynomial multiplication
...
%            \textit{and/or} \function{divide()} uses a super-polynomial division
