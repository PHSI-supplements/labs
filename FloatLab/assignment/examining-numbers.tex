...
Try some other numbers that you can easily convert to base-two by hand, and see if your \function{denormalize()} function correctly unpacks their IEEE~754 representation and correctly sets the \lstinline{unnormal_t} fields.
