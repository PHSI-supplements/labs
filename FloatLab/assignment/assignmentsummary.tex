...
\ifbool{offerdecompositionhints}{
    ...
    We start you with some bit masks that will allow you to examine specific bit fields within an IEEE~754 formatted value.
    Then you will create some constants based on your understanding of IEEE~754.
    You can then use some of the bit masks and your understanding of IEEE~754 to create some simple functions to test qualityies of an IEEE~754 formatted value.
