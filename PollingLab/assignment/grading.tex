...
\begin{description}
    ...
    \rubricitem{1}{The correct addresses are assigned to \lstinline{ioports} and \lstinline{i2c}}
    ...
    \rubricitem{6}{The \function{send_halfbyte()} function is correctly implemented (3 points for the I$^2$C protocol, 3 points for data sent to the display module)}
    ...
    \item[Penalties]
    \penaltyitem{4}{The functions from Section~\ref{sec:LabTime} violate one or more constraints identified in Section~\ref{subsec:constraints}.}
    \penaltyitem{3}{The simple I/O functions from Section~\ref{sec:MemMapIO} violate one or more constraints identified in Section~\ref{subsec:constraints}.}
    \penaltyitem{8}{The \function{get_keypress()} function violates one or more constraints identified in Section~\ref{subsec:constraints}.}
    \penaltyitem{6}{The \function{send_halfbyte()} function violates one or more constraints identified in Section~\ref{subsec:constraints}.}
