...
\begin{description}
    ...
    \rubricitem{3}{The simple input/output functions are correctly implemented (1 point for \\ \function{xx_switch_is_in_right_position()} functions; 1 point for \function{xx_button_is_pressed()} functions; 1 point for \function{set_xx_led()} functions)}
