%%
%% MemoryLab (c) 2021 Christopher A. Bohn
%%
...
\rubricitem{2}{Drawing reasonable conclusions about the sizes of the Xeon's L1, L2, and L3 caches.}
\rubricitem{2}{Drawing a reasonable conclusion about the size of the Xeon's cache line, or about the size of the Intel Core i7's cache line.}
\end{description}
