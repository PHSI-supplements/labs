...
Be sure to compile and test your code in the course container with the original driver code; the original *fpu.h*, *unnormal.h*, and *ieee754-to-string.h*; and the original CMake configuration files.
