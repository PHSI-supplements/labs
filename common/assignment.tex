...
\newcommand{\filesource}{Canvas or {\footnotesize$\sim$}cse231 on \textit{cse-linux-01.unl.edu}}
\newcommand{\filesubmission}{Canvas}

% Individual or team effort

\newcommand{\collaborationrules}{}
\newcommand{\individualeffort}{This is an individual-effort project.
...
\newcommand{\labpartnerthenindividual}{This is an individual-effort project with a limited opportunity for collaboration.
    ...
    Sharing code with or copying code from another student or the internet is prohibited.}
\newcommand{\labsectionthenindividual}[1]{This is an individual-effort project with a limited opportunity for collaboration.
    During your scheduled lab time, you may discuss problem decomposition and solution design with other students for Section~{#1} only.
    ...
    Sharing code with or copying code from another student or the internet is prohibited.}
\newcommand{\teameffort}{This is a team-effort project.
