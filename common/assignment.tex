...
\newcommand{\policyforcodethatdoesnotcompile}{  % Leave empty if you choose not to set a policy
    ...
    Before turning in your code, be sure that your code compiles on \runtimeenvironment\ with the original driver code, the original header file(s), and the original \textit{Makefile}.
}
...
\newcommand{\defaultlatepolicy}{    % The one you will use for most assignments; leave empty if you choose not to set a policy
    ...
    The due date in \filesubmission\ is five minutes after that, which is ample time for you to arrive to lab and then discover that you'd forgotten to turn in your work.
...
% Some students need a little extra help breaking big problems into smaller problems
