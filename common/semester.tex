...
\newcommand{\keyboardlabnumber}{xx}
\newcommand{\keyboardlabcollaboration}{\individualeffort}
\newcommand{\keyboardlabdue}{soon}

\newcommand{\pointerlabnumber}{xx}
\newcommand{\pointerlabcollaboration}{\individualeffort}
\newcommand{\pointerlabdue}{soon}

\newcommand{\keyboardpointerlabnumber}{2}
\newcommand{\keyboardpointerlabcollaboration}{\individualeffort}
\newcommand{\keyboardpointerlabdue}{Week of September 12, before the start of your lab section}

\newcommand{\integerlabnumber}{3}
\newcommand{\integerlabcollaboration}{\individualeffort}
\newcommand{\integerlabdue}{Week of September 19, before the start of your lab section}
\newcommand{\integerlablatepolicy}{\defaultlatepolicy}

\newcommand{\floatlabnumber}{4}
\newcommand{\floatlabcollaboration}{\individualeffort}
\newcommand{\floatlabdue}{Week of September 26, before the start of your lab section}

\newcommand{\addressinglabnumber}{5}
\newcommand{\addressinglabcollaboration}{\individualeffort}
\newcommand{\addressinglabdue}{Week of October 3, before the start of your lab section}

%bomblab: 6, due Oct 19/20/21
%attacklab: 7, due Oct 26/31/Nov1

\newcommand{\duplicatorlabnumber}{8}
...
\newcommand{\ioprelabdue}{Before the start of your lab section on November 2, 7, or 8}
...
\newcommand{\memorylabdue}{Week of December 5, at the end of your lab section}
