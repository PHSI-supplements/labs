...
%bomblab: 6, due Oct 13/14/15? 19/20/21?
%attacklab: 7, due Oct 26/27/31

%new concurrencylab: 8, due Nov 2/3/7

\newcommand{\pollinglabnumber}{9}
\newcommand{\pollinglabcollaboration}{\individualeffort}
\newcommand{\pollinglabdue}{Before the start of your lab section on November 9, 10, or 14}
...
\newcommand{\ioprelabdue}{Before the start of your lab section on November 2, 3, or 7}

\newcommand{\interruptlabnumber}{10}
\newcommand{\interruptlabcollaboration}{\individualeffort}
\newcommand{\interruptlabdue}{Before the start of your lab section on November 16, 17, or 21}
...
\newcommand{\capstonelabdue}{Before the start of your lab section on November 30, December 1, or December 2\footnote{See Piazza for the due dates of teams with students from different lab sections.}}
