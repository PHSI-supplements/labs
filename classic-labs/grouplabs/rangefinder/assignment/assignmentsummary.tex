...
This prohibition includes, but is not limited to, the \function{micros()}, \function{tone()}, \function{noTone()}, \function{pulseIn()}, and \function{pulseInLong()} functions.

\subsubsection{Constraints on AVR-libc and on MBED OS}
