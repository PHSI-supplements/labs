...
\begin{description}
    \checkoffitem{Press the \textbf{1} key on the numeric keypad (\textit{Memory access time}).}
\end{description}
...
\begin{description}
    \checkoffitem{Press the left pushbutton to return to the main menu.}
\end{description}
...
\begin{description}
    \checkoffitem{Press the \textbf{2} key on the numeric keypad (\textit{Cache size}).}
\end{description}
...
\begin{description}
    \checkoffitem{Open the ``Data'' tab in \textit{CacheCharts.xlsx} and locate the portion labeled ``CACHE SIZE''.}
    \checkoffitem{Copy the times reported for working sets sized 32--80 bytes into the spreadsheet's cells B2--B6.}
    \checkoffitem{Press the left button to advance to the next page of data.}
\end{description}

\begin{figure}[h]
    \subfloat{\includegraphics[width=3cm]{Mk4Screens/Option2Screen2}}
    \hfil
    \subfloat{\includegraphics[width=3cm]{Mk4Screens/Option2Screen3}}
    \hfil
    \subfloat{\includegraphics[width=3cm]{Mk4Screens/Option2Screen4}}
    \hfil
    \subfloat{\includegraphics[width=3cm]{Mk4Screens/Option2Screen5}}
    \hfil
    \subfloat{\includegraphics[width=3cm]{Mk4Screens/Option2Screen6}}
\end{figure}

\begin{description}
    \checkoffitem{Repeatedly copy the times reported into the appropriate cells in the spreadsheet, using the left pushbutton to advance through the pages.}
    \checkoffitem{When you have finished, use the left pushbutton to return to the main menu.}
...
\begin{description}
    \checkoffitem{Press the \textbf{3} key on the numeric keypad (\textit{Cache line size}).}
\end{description}

A screen with the time to access each of the memories will be displayed:

\begin{figure}[h]
    \includegraphics[height=3cm]{Mk4Screens/Option3Screen1}
\end{figure}

\newpage

\begin{description}
    \checkoffitem{Open the ``Data'' tab in \textit{CacheCharts.xlsx} and locate the portion labeled ``STRIDE''.}
    \checkoffitem{Copy the times reported for strides of 2--32 bytes into the spreadsheet's cells B40--B44.}
    \checkoffitem{Press the left button to advance to the next page of data.}
\end{description}

\begin{figure}[h]
    \includegraphics[height=3cm]{Mk4Screens/Option3Screen2}
\end{figure}

\begin{description}
    \checkoffitem{Copy the times reported for strides of 64--512 bytes into the spreadsheet's cells B45--B48.}
    \checkoffitem{Press the left button to advance to the next page of data.}
...
\begin{description}
    \checkoffitem{Save \textit{CacheCharts.xlsx} \textit{answers.txt}.}
\end{description}
